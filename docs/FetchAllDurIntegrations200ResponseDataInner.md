...
json = "{}"
# create an instance of FetchAllDurIntegrations200ResponseDataInner from a JSON string
fetch_all_dur_integrations200_response_data_inner_instance = FetchAllDurIntegrations200ResponseDataInner.from_json(json)
# print the JSON string representation of the object
print(FetchAllDurIntegrations200ResponseDataInner.to_json())

# convert the object into a dict
fetch_all_dur_integrations200_response_data_inner_dict = fetch_all_dur_integrations200_response_data_inner_instance.to_dict()
# create an instance of FetchAllDurIntegrations200ResponseDataInner from a dict
fetch_all_dur_integrations200_response_data_inner_from_dict = FetchAllDurIntegrations200ResponseDataInner.from_dict(fetch_all_dur_integrations200_response_data_inner_dict)
```
