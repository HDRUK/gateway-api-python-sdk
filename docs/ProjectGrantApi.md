...
> CreateProjectGrant201Response create_project_grant()
...
with gateway_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # ProjectGrantController@store
        api_response = api_instance.create_project_grant()
        print("The response of ProjectGrantApi->create_project_grant:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectGrantApi->create_project_grant: %s\n" % e)
```
