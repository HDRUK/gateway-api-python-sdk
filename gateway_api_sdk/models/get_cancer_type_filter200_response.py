...
class GetCancerTypeFilter200Response(BaseModel):
    """
    GetCancerTypeFilter200Response
    """ # noqa: E501
    data: Optional[GetCancerTypeFilters200ResponseDataInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GetCancerTypeFilters200ResponseDataInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
