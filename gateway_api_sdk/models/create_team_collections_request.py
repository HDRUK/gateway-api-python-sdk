...
class CreateTeamCollectionsRequest(BaseModel):
    """
    ...
    tools: Optional[List[CreateTeamCollectionsRequestDatasetsInner]] = Field(default=None, json_schema_extra={"examples": ["[]"]})
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "image_link", "enabled", "keywords", "datasets", "tools", "dur", "publications", "public"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tools": [CreateTeamCollectionsRequestDatasetsInner.from_dict(_item) for _item in obj["tools"]] if obj.get("tools") is not None else None,
