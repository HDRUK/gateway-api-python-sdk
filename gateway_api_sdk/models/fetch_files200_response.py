...
class FetchFiles200Response(BaseModel):
    """
    FetchFiles200Response
    """ # noqa: E501
    data: Optional[List[FetchFiles200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [FetchFiles200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
