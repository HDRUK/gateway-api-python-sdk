...
class A18eed83ffe8ac895df3e1efa5ffb421Request(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "image_link", "enabled", "keywords", "datasets", "dur", "publications", "public"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of A18eed83ffe8ac895df3e1efa5ffb421Request from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of A18eed83ffe8ac895df3e1efa5ffb421Request from a dict"""
        if obj is None:
            return None
