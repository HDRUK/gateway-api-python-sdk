...
class FetchAllTools200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["data", "current_page", "first_page_url", "from", "last_page", "last_page_url", "links", "next_page_url", "path", "per_page", "prev_page_url", "to", "total"]
