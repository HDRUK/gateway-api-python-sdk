...
class FetchDarTemplate200Response(BaseModel):
    """
    FetchDarTemplate200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    data: Optional[FetchDarTemplates200ResponseDataInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": FetchDarTemplates200ResponseDataInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
