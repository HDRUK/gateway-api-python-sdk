...
class FetchAllSitemap200Response(BaseModel):
    """
    FetchAllSitemap200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    data: Optional[List[FetchAllSitemap200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [FetchAllSitemap200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
