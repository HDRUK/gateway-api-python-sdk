...
class UpdateUserHasRolesRequest(BaseModel):
    """
    UpdateUserHasRolesRequest
    """ # noqa: E501
    roles: Optional[UpdateUserHasRolesRequestRoles] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": UpdateUserHasRolesRequestRoles.from_dict(obj["roles"]) if obj.get("roles") is not None else None
        })
        return _obj
