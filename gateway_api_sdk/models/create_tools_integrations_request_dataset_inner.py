...
class CreateToolsIntegrationsRequestDatasetInner(BaseModel):
    """
    CreateToolsIntegrationsRequestDatasetInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [1]})
    link_type: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Other"]})
    __properties: ClassVar[List[str]] = ["id", "link_type"]
