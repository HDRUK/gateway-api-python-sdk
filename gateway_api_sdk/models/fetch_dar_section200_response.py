...
class FetchDarSection200Response(BaseModel):
    """
    FetchDarSection200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    data: Optional[FetchDarSections200ResponseDataInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": FetchDarSections200ResponseDataInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
