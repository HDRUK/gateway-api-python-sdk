...
class Model928c1c4e39f13593bdec88641ee83120200ResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "deleted_at", "filename", "file_location", "user_id", "status", "application_id", "question_id", "error"]
