...
class Model75c378b5764d9d73e14fe2d65c654910Request(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "image_link", "enabled", "keywords", "datasets", "dur", "publications", "public", "status"]
