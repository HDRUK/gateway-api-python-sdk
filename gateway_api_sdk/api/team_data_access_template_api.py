...
class TeamDataAccessTemplateApi:
    ...
    def _delete_team_dar_template_file_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/teams/{teamId}/dar/templates/{id}/files/{fileId}',
    ...
    def _fetch_team_dar_templates_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/teams/{teamId}/dar/templates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def team_dar_template_count_unique_fields(
        self,
        team_id: Annotated[StrictInt, Field(description="Team id")],
        ...
        _param = self._team_dar_template_count_unique_fields_serialize(
            team_id=team_id,
            var_field=var_field,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def team_dar_template_count_unique_fields_with_http_info(
        self,
        team_id: Annotated[StrictInt, Field(description="Team id")],
        var_field: Annotated[StrictStr, Field(description="name of the field to perform a count on")],
        _request_timeout: Union[
    ...
    @validate_call
    def team_dar_template_count_unique_fields_without_preload_content(
        self,
        team_id: Annotated[StrictInt, Field(description="Team id")],
        var_field: Annotated[StrictStr, Field(description="name of the field to perform a count on")],
        _request_timeout: Union[
    ...
    def _team_dar_template_count_unique_fields_serialize(
        self,
        team_id,
        var_field,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/teams/{teamId}/dar/templates/count/{field}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
