...
from gateway_api_sdk.configuration import Configuration
from gateway_api_sdk.api_response import ApiResponse, T as ApiResponseT
import gateway_api_sdk.models
from gateway_api_sdk import rest
from gateway_api_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.0.0-test3/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gateway_api_sdk.models, klass)
